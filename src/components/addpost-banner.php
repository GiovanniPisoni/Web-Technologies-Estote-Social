            ...
            <div class="modal-body">
                <form action="#" method="POST" id="addPostForm" enctype="multipart/form-data">
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" class="size-container img-fluid mx-auto" id="container" alt="Post image">
                    </div>
